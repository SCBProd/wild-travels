...
const profileEditSchema = Yup.object({
  name: Yup.string()
    ...
    .matches(/^\p{L}+(?:[ '’-]\p{L}+)*$/u, "Введіть коректне ім'я та прізвище")
  ...
  newPassword: Yup.string()
    .test('new-password-required', 'Введіть новий пароль', function (value) {
      const { currentPassword, confirmNewPassword } = this
        .parent as ProfileEditValues;
  ...
  confirmNewPassword: Yup.string()
    ...
    .test('passwords-match', 'Паролі не збігаються', function (value) {
...
function getProfileErrorMessage(error: unknown) {
  ...
  const messages: Record<string, string> = {
    'Current password is incorrect': 'Введено неправильний поточний пароль',
    'Invalid current password': 'Введено неправильний поточний пароль',
    'User not found': 'Користувача не знайдено',
    'Not authorized': 'Ви не авторизовані',
  };
      ...
      >
        {({
          ...
          const nameHasSuccess = Boolean(
            touched.name && values.name.trim() && !errors.name,
          );
          ...
          const newPasswordHasSuccess = Boolean(
            touched.newPassword && values.newPassword && !errors.newPassword,
          );
          ...
          return (
            ...
            >
                ...
                <div className={styles.avatarActions}>
                  <input
                    ...
                    onChange={async (event) => {
                      ...
                      await setFieldTouched('avatar', true, true);
                      ...
                      if (file.size > MAX_AVATAR_SIZE) {
                        setAvatarPreview(null);
                        toast.error('Фото має бути менше 1 MB');
                        return;
                      }
                  ...
                  <Field
                    id="avatar-error"
                    message={touched.avatar ? errors.avatar : undefined}
                  />
                </div>
              </div>
              ...
              <div className={styles.passwordBlock}>
                ...
                <div className={styles.field}>
                  ...
                  <input
                    ...
                    aria-describedby={
                      newPasswordHasError ? 'new-password-error' : undefined
                    }
                  />
              ...
              {status && (
                <Field id="profile-edit-request-error" message={status} />
              )}
